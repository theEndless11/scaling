import { hasInjectionContext, getCurrentInstance, inject, createApp, provide, onErrorCaptured, onServerPrefetch, unref, createVNode, resolveDynamicComponent, shallowReactive, reactive, effectScope, toRef, defineAsyncComponent, mergeProps, getCurrentScope, computed, defineComponent, h, isReadonly, useSSRContext, isRef, isShallow, isReactive, toRaw } from 'vue';
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-Cng2pDJi.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DH6UmPCl.mjs'));
